...
| `autoMigrate`                                |                                | `false`                           |
| `serverUrl`                                  |                                | `nil`                             |
| `external.storage.enabled`                   |                                | `false`                           |
| `external.storage.endpoint`                  |                                | `nil`                             |
| `external.storage.accessKey`                 |                                | `nil`                             |
| `external.storage.secretKey`                 |                                | `nil`                             |
| `external.storage.bucket`                    |                                | `hasura-plus`                     |
| `external.storage.ssl`                       |                                | `true`                            |
