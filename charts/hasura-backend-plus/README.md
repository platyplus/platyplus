...
| `storage.rules`                              | Custom HBP [storage rules](https://nhost.github.io/hasura-backend-plus/configuration.html#storage-rules)  | [Default HBP storage rules](https://github.com/nhost/hasura-backend-plus/blob/master/custom/storage-rules/rules.yaml) |
