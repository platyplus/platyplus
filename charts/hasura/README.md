...
| `postgresql.postgresqlPassword`  | **ATTENTION** if value changes, you also need to change password through psql as it is persisted | autogenerated           |
...
| `jwt.algorithm`                          | HASURA_GRAPHQL_JWT_SECRET.type (HS256, HS384, HS512, RS256, RS384, RS512) | `HS256`                                                   |
