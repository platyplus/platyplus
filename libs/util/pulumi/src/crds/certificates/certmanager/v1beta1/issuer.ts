...
export class Issuer extends pulumi.CustomResource {
  ...
  public readonly apiVersion!: pulumi.Output<
    'cert-manager.io/v1beta1' | undefined
  >
  ...
  public readonly status!: pulumi.Output<
    outputs.certmanager.v1beta1.IssuerStatus | undefined
  >
...
export interface IssuerArgs {
   ...
   * Desired state of the Issuer resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1beta1.IssuerSpec>
  /**
   * Status of the Issuer. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1beta1.IssuerStatus>
}
