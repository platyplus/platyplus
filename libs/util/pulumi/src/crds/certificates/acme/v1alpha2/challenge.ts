...
export class Challenge extends pulumi.CustomResource {
  ...
  public static readonly __pulumiType =
    'kubernetes:acme.cert-manager.io/v1alpha2:Challenge'
...
export interface ChallengeArgs {
  ...
  readonly spec?: pulumi.Input<inputs.acme.v1alpha2.ChallengeSpec>
  readonly status?: pulumi.Input<inputs.acme.v1alpha2.ChallengeStatus>
}
