...
export class Order extends pulumi.CustomResource {
  ...
  public readonly status!: pulumi.Output<
    outputs.acme.v1beta1.OrderStatus | undefined
  >
...
export interface OrderArgs {
  ...
  readonly spec?: pulumi.Input<inputs.acme.v1beta1.OrderSpec>
  readonly status?: pulumi.Input<inputs.acme.v1beta1.OrderStatus>
}
