...
export class ClusterIssuer extends pulumi.CustomResource {
  ...
  public readonly spec!: pulumi.Output<
    outputs.certmanager.v1alpha2.ClusterIssuerSpec | undefined
  >
  /**
...
export interface ClusterIssuerArgs {
   ...
   * Desired state of the ClusterIssuer resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1alpha2.ClusterIssuerSpec>
  /**
   * Status of the ClusterIssuer. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1alpha2.ClusterIssuerStatus>
}
