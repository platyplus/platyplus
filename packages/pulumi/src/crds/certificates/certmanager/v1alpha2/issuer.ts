...
export class Issuer extends pulumi.CustomResource {
  ...
  public static readonly __pulumiType =
    'kubernetes:cert-manager.io/v1alpha2:Issuer'
  ...
  public readonly apiVersion!: pulumi.Output<
    'cert-manager.io/v1alpha2' | undefined
  >
  ...
  public readonly spec!: pulumi.Output<
    outputs.certmanager.v1alpha2.IssuerSpec | undefined
  >
  /**
   * Status of the Issuer. This is set and managed automatically.
   */
  public readonly status!: pulumi.Output<
    outputs.certmanager.v1alpha2.IssuerStatus | undefined
  >
...
export interface IssuerArgs {
   ...
   * Desired state of the Issuer resource.
   */
  readonly spec?: pulumi.Input<inputs.certmanager.v1alpha2.IssuerSpec>
  /**
   * Status of the Issuer. This is set and managed automatically.
   */
  readonly status?: pulumi.Input<inputs.certmanager.v1alpha2.IssuerStatus>
}
