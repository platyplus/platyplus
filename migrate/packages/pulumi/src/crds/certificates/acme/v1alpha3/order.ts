...
export class Order extends pulumi.CustomResource {
  ...
  public static readonly __pulumiType =
    'kubernetes:acme.cert-manager.io/v1alpha3:Order'
  ...
  public readonly spec!: pulumi.Output<
    outputs.acme.v1alpha3.OrderSpec | undefined
  >
  public readonly status!: pulumi.Output<
    outputs.acme.v1alpha3.OrderStatus | undefined
  >
...
export interface OrderArgs {
  ...
  readonly spec?: pulumi.Input<inputs.acme.v1alpha3.OrderSpec>
  readonly status?: pulumi.Input<inputs.acme.v1alpha3.OrderStatus>
}
