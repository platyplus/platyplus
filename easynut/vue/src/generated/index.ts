...
/** columns and relationships of "metadata.version" */
export type Metadata_Version = {
  __typename?: 'metadata_version'
  cli_state: Maybe<Scalars['jsonb']>
  console_state: Maybe<Scalars['jsonb']>
  hasura_uuid: Maybe<Scalars['uuid']>
  upgraded_on: Maybe<Scalars['timestamptz']>
  version: Maybe<Scalars['String']>
}

/** columns and relationships of "metadata.version" */
export type Metadata_VersionCli_StateArgs = {
  path: Maybe<Scalars['String']>
}

/** columns and relationships of "metadata.version" */
export type Metadata_VersionConsole_StateArgs = {
  path: Maybe<Scalars['String']>
}

/** aggregated selection of "metadata.version" */
export type Metadata_Version_Aggregate = {
  __typename?: 'metadata_version_aggregate'
  aggregate: Maybe<Metadata_Version_Aggregate_Fields>
  nodes: Array<Metadata_Version>
}

/** aggregate fields of "metadata.version" */
export type Metadata_Version_Aggregate_Fields = {
  __typename?: 'metadata_version_aggregate_fields'
  count: Maybe<Scalars['Int']>
  max: Maybe<Metadata_Version_Max_Fields>
  min: Maybe<Metadata_Version_Min_Fields>
}

/** aggregate fields of "metadata.version" */
export type Metadata_Version_Aggregate_FieldsCountArgs = {
  columns: Maybe<Array<Metadata_Version_Select_Column>>
  distinct: Maybe<Scalars['Boolean']>
}

/** order by aggregate values of table "metadata.version" */
export type Metadata_Version_Aggregate_Order_By = {
  count: Maybe<Order_By>
  max: Maybe<Metadata_Version_Max_Order_By>
  min: Maybe<Metadata_Version_Min_Order_By>
}

/** append existing jsonb value of filtered columns with new jsonb value */
export type Metadata_Version_Append_Input = {
  cli_state: Maybe<Scalars['jsonb']>
  console_state: Maybe<Scalars['jsonb']>
}

/** input type for inserting array relation for remote table "metadata.version" */
export type Metadata_Version_Arr_Rel_Insert_Input = {
  data: Array<Metadata_Version_Insert_Input>
}

/** Boolean expression to filter rows from the table "metadata.version". All fields are combined with a logical 'AND'. */
export type Metadata_Version_Bool_Exp = {
  _and: Maybe<Array<Maybe<Metadata_Version_Bool_Exp>>>
  _not: Maybe<Metadata_Version_Bool_Exp>
  _or: Maybe<Array<Maybe<Metadata_Version_Bool_Exp>>>
  cli_state: Maybe<Jsonb_Comparison_Exp>
  console_state: Maybe<Jsonb_Comparison_Exp>
  hasura_uuid: Maybe<Uuid_Comparison_Exp>
  upgraded_on: Maybe<Timestamptz_Comparison_Exp>
  version: Maybe<String_Comparison_Exp>
}

/** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
export type Metadata_Version_Delete_At_Path_Input = {
  cli_state: Maybe<Array<Maybe<Scalars['String']>>>
  console_state: Maybe<Array<Maybe<Scalars['String']>>>
}

/** delete the array element with specified index (negative integers count from the end). throws an error if top level container is not an array */
export type Metadata_Version_Delete_Elem_Input = {
  cli_state: Maybe<Scalars['Int']>
  console_state: Maybe<Scalars['Int']>
}

/** delete key/value pair or string element. key/value pairs are matched based on their key value */
export type Metadata_Version_Delete_Key_Input = {
  cli_state: Maybe<Scalars['String']>
  console_state: Maybe<Scalars['String']>
}

/** input type for inserting data into table "metadata.version" */
export type Metadata_Version_Insert_Input = {
  cli_state: Maybe<Scalars['jsonb']>
  console_state: Maybe<Scalars['jsonb']>
  hasura_uuid: Maybe<Scalars['uuid']>
  upgraded_on: Maybe<Scalars['timestamptz']>
...
/** aggregate max on columns */
export type Metadata_Version_Max_Fields = {
  __typename?: 'metadata_version_max_fields'
  hasura_uuid: Maybe<Scalars['uuid']>
  upgraded_on: Maybe<Scalars['timestamptz']>
  version: Maybe<Scalars['String']>
}

/** order by max() on columns of table "metadata.version" */
export type Metadata_Version_Max_Order_By = {
  hasura_uuid: Maybe<Order_By>
  upgraded_on: Maybe<Order_By>
  version: Maybe<Order_By>
}

/** aggregate min on columns */
export type Metadata_Version_Min_Fields = {
  __typename?: 'metadata_version_min_fields'
  hasura_uuid: Maybe<Scalars['uuid']>
  upgraded_on: Maybe<Scalars['timestamptz']>
  version: Maybe<Scalars['String']>
}

/** order by min() on columns of table "metadata.version" */
export type Metadata_Version_Min_Order_By = {
  hasura_uuid: Maybe<Order_By>
  upgraded_on: Maybe<Order_By>
  version: Maybe<Order_By>
}

/** response of any mutation on the table "metadata.version" */
export type Metadata_Version_Mutation_Response = {
  __typename?: 'metadata_version_mutation_response'
  /** number of affected rows by the mutation */
  affected_rows: Scalars['Int']
  /** data of the affected rows by the mutation */
  returning: Array<Metadata_Version>
}

/** input type for inserting object relation for remote table "metadata.version" */
export type Metadata_Version_Obj_Rel_Insert_Input = {
  data: Metadata_Version_Insert_Input
}

/** ordering options when selecting data from "metadata.version" */
export type Metadata_Version_Order_By = {
  cli_state: Maybe<Order_By>
  console_state: Maybe<Order_By>
  hasura_uuid: Maybe<Order_By>
  upgraded_on: Maybe<Order_By>
  version: Maybe<Order_By>
}
...
/** prepend existing jsonb value of filtered columns with new jsonb value */
export type Metadata_Version_Prepend_Input = {
  cli_state: Maybe<Scalars['jsonb']>
  console_state: Maybe<Scalars['jsonb']>
}

/** select columns of table "metadata.version" */
export enum Metadata_Version_Select_Column {
  /** column name */
  CliState = 'cli_state',
  /** column name */
  ConsoleState = 'console_state',
  /** column name */
  HasuraUuid = 'hasura_uuid',
  /** column name */
  UpgradedOn = 'upgraded_on',
  /** column name */
  Version = 'version'
}

/** input type for updating data in table "metadata.version" */
export type Metadata_Version_Set_Input = {
  cli_state: Maybe<Scalars['jsonb']>
  console_state: Maybe<Scalars['jsonb']>
  hasura_uuid: Maybe<Scalars['uuid']>
  upgraded_on: Maybe<Scalars['timestamptz']>
...
export type Mutation_Root = {
  ...
  /** delete data from the table: "metadata.version" */
  delete_metadata_version: Maybe<Metadata_Version_Mutation_Response>
  ...
  /** insert data into the table: "metadata.version" */
  insert_metadata_version: Maybe<Metadata_Version_Mutation_Response>
  /** insert a single row into the table: "metadata.version" */
  insert_metadata_version_one: Maybe<Metadata_Version>
  ...
  /** update data of the table: "metadata.version" */
  update_metadata_version: Maybe<Metadata_Version_Mutation_Response>
...
/** mutation root */
export type Mutation_RootDelete_Metadata_VersionArgs = {
  where: Metadata_Version_Bool_Exp
}
...
/** mutation root */
export type Mutation_RootInsert_Metadata_VersionArgs = {
  objects: Array<Metadata_Version_Insert_Input>
}

/** mutation root */
export type Mutation_RootInsert_Metadata_Version_OneArgs = {
  object: Metadata_Version_Insert_Input
}
...
/** mutation root */
export type Mutation_RootUpdate_Metadata_VersionArgs = {
  _append: Maybe<Metadata_Version_Append_Input>
  _delete_at_path: Maybe<Metadata_Version_Delete_At_Path_Input>
  _delete_elem: Maybe<Metadata_Version_Delete_Elem_Input>
  _delete_key: Maybe<Metadata_Version_Delete_Key_Input>
  _prepend: Maybe<Metadata_Version_Prepend_Input>
  _set: Maybe<Metadata_Version_Set_Input>
  where: Metadata_Version_Bool_Exp
}
...
export type Query_Root = {
  ...
  /** fetch data from the table: "metadata.version" */
  metadata_version: Array<Metadata_Version>
  /** fetch aggregated fields from the table: "metadata.version" */
  metadata_version_aggregate: Metadata_Version_Aggregate
...
/** query root */
export type Query_RootMetadata_VersionArgs = {
  distinct_on: Maybe<Array<Metadata_Version_Select_Column>>
  limit: Maybe<Scalars['Int']>
  offset: Maybe<Scalars['Int']>
  order_by: Maybe<Array<Metadata_Version_Order_By>>
  where: Maybe<Metadata_Version_Bool_Exp>
}

/** query root */
export type Query_RootMetadata_Version_AggregateArgs = {
  distinct_on: Maybe<Array<Metadata_Version_Select_Column>>
  limit: Maybe<Scalars['Int']>
  offset: Maybe<Scalars['Int']>
  order_by: Maybe<Array<Metadata_Version_Order_By>>
...
/** subscription root */
export type Subscription_RootMetadata_VersionArgs = {
  distinct_on: Maybe<Array<Metadata_Version_Select_Column>>
  limit: Maybe<Scalars['Int']>
  offset: Maybe<Scalars['Int']>
  order_by: Maybe<Array<Metadata_Version_Order_By>>
...
/** subscription root */
export type Subscription_RootMetadata_Version_AggregateArgs = {
  distinct_on: Maybe<Array<Metadata_Version_Select_Column>>
  limit: Maybe<Scalars['Int']>
  offset: Maybe<Scalars['Int']>
  order_by: Maybe<Array<Metadata_Version_Order_By>>
