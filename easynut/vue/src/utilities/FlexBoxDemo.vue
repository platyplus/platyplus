<template>
  <div class="p-grid">
    <div class="p-col-12">
      <h4>FlexBox</h4>
      <p>
        Easily manage the layout of your components with the responsive FlexBox
        utilities. If you require a utility to manage the layout of your
...
&lt;/div&gt;
      ...
      <p>
        ...
        <i>p-order-{value}</i> format is used where value can be a number from 0
        to 6.
      </p>
...
&lt;/div&gt;
      ...
      <p>
        ...
        the container. The format of the class is <i>p-flex-{value}</i> and the
        value field can be either of the listed alternatives.
      </p>
...
&lt;/div&gt;
      ...
      <p>
        ...
        the <i>p-jc-{value}</i> format with responsive alternatives. Value field
        accepts the options below.
      </p>
      <ul>
        <li>start</li>
        <li>end</li>
...
&lt;/div&gt;
      ...
      <p>
        ...
        particular element and defined using the <i>p-as-{value}</i> format with
...
&lt;/div&gt;
      ...
      <p>
        ...
        the <i>p-ac-{value}</i> format with responsive alternatives. Value field
        accepts the options below.
      </p>
      <ul>
        <li>start</li>
